...
public class MyFile implements Model {
  ...
  public static class $generated__1_class implements SupportFactor.Support {
    public boolean isInSupport() {
      return $generated__1(rand);
    }
    ...
    public $generated__1_class(final Random rand) {
      this.rand = rand;
    }
  }
  ...
  public Collection<ModelComponent> components() {
    ...
    for (int i : $generated__0(rand)) {
      { // Code generated by: (rand) { rand.nextInt(4) > 2 }
        ...
        components.add(
          new SupportFactor(new $generated__1_class(rand))
          );
      }
    }
