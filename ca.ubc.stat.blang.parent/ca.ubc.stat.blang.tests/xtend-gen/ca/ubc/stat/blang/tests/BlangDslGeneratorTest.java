...
public class BlangDslGeneratorTest {
  ...
  @Test
  public void logScaleFactorMultiVar() {
    try {
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("model {");
      _builder.newLine();
      ...
      _builder.newLine();
      _builder.append("        ");
      _builder.append("logf(x, mean, variance) = {");
      _builder.newLine();
      _builder.append("            ");
      _builder.append("-0.5 * (x.doubleValue - mean.doubleValue)**2 / variance.doubleValue");
      _builder.newLine();
      _builder.append("        ");
      _builder.append("}");
      _builder.newLine();
      ...
      _builder_1.newLine();
      _builder_1.append("  ");
      _builder_1.append("public final Real x;");
      _builder_1.newLine();
      _builder_1.append("  ");
      _builder_1.newLine();
      _builder_1.append("  ");
      _builder_1.append("public MyFile(final Real x, final Supplier<Real> mean, final Supplier<Real> variance) {");
      _builder_1.newLine();
      _builder_1.append("    ");
      _builder_1.append("this.mean = mean;");
      _builder_1.newLine();
      ...
      _builder_1.newLine();
      _builder_1.append("    ");
      _builder_1.append("components.add(new $Generated_LogScaleFactor0(x, mean, variance));");
      _builder_1.newLine();
      _builder_1.append("    ");
      _builder_1.newLine();
      _builder_1.append("    ");
      ...
      _builder_1.newLine();
      _builder_1.append("    ");
      _builder_1.append("private final Real x;");
      _builder_1.newLine();
      _builder_1.append("    ");
      _builder_1.newLine();
      _builder_1.append("    ");
      ...
      _builder_1.newLine();
      _builder_1.append("    ");
      _builder_1.append("public $Generated_LogScaleFactor0(final Real x, final Supplier<Real> mean, final Supplier<Real> variance) {");
      _builder_1.newLine();
      _builder_1.append("      ");
      _builder_1.append("this.x = x;");
      _builder_1.newLine();
      ...
      _builder_1.newLine();
      _builder_1.append("      ");
      _builder_1.append("return $logDensity(x, mean.get(), variance.get());");
      _builder_1.newLine();
      _builder_1.append("    ");
      _builder_1.append("}");
      _builder_1.newLine();
      ...
      _builder_1.newLine();
      _builder_1.append("    ");
      _builder_1.append("private double $logDensity(final Real x, final Real mean, final Real variance) {");
      _builder_1.newLine();
      _builder_1.append("      ");
      _builder_1.append("double _doubleValue = x.doubleValue();");
      _builder_1.newLine();
      _builder_1.append("      ");
      _builder_1.append("double _doubleValue_1 = mean.doubleValue();");
      _builder_1.newLine();
      _builder_1.append("      ");
      _builder_1.append("double _minus = (_doubleValue - _doubleValue_1);");
      _builder_1.newLine();
      _builder_1.append("      ");
      _builder_1.append("double _multiply = ((-0.5) * _minus);");
      _builder_1.newLine();
      _builder_1.append("      ");
      _builder_1.append("double _power = Math.pow(_multiply, 2);");
      _builder_1.newLine();
      _builder_1.append("      ");
      _builder_1.append("double _doubleValue_2 = variance.doubleValue();");
      _builder_1.newLine();
      _builder_1.append("      ");
      _builder_1.append("return (_power / _doubleValue_2);");
      _builder_1.newLine();
      _builder_1.append("    ");
      _builder_1.append("}");
      _builder_1.newLine();
  ...
  @Test
  public void supportFactorRandom() {
    try {
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("model {");
      _builder.newLine();
      _builder.append("    ");
      _builder.append("random java.util.Random rand");
      _builder.newLine();
      _builder.append("    ");
      _builder.newLine();
      _builder.append("    ");
      ...
      _builder.newLine();
      _builder.append("        ");
      _builder.append("indicator(rand) = rand.nextBoolean()");
      _builder.newLine();
      _builder.append("    ");
      _builder.append("}");
      _builder.newLine();
      ...
      _builder_1.append("import java.util.Collection;");
      _builder_1.newLine();
      _builder_1.append("import java.util.Random;");
      _builder_1.newLine();
      _builder_1.newLine();
      _builder_1.append("@SuppressWarnings(\"all\")");
      _builder_1.newLine();
      ...
      _builder_1.newLine();
      _builder_1.append("  ");
      _builder_1.append("public final Random rand;");
      _builder_1.newLine();
      _builder_1.append("  ");
      _builder_1.newLine();
      _builder_1.append("  ");
      _builder_1.append("public MyFile(final Random rand) {");
      _builder_1.newLine();
      _builder_1.append("    ");
      _builder_1.append("this.rand = rand;");
      _builder_1.newLine();
      _builder_1.append("  ");
      _builder_1.append("}");
      _builder_1.newLine();
      ...
      _builder_1.newLine();
      _builder_1.append("    ");
      _builder_1.append("components.add(new blang.core.SupportFactor(new $Generated_SetupSupport0(rand)));");
      _builder_1.newLine();
      _builder_1.append("    ");
      _builder_1.newLine();
      _builder_1.append("    ");
      ...
      _builder_1.newLine();
      _builder_1.append("    ");
      _builder_1.append("private final Random rand;");
      _builder_1.newLine();
      _builder_1.append("    ");
      _builder_1.newLine();
      _builder_1.append("    ");
      _builder_1.append("public $Generated_SetupSupport0(final Random rand) {");
      _builder_1.newLine();
      _builder_1.append("      ");
      _builder_1.append("this.rand = rand;");
      _builder_1.newLine();
      ...
      _builder_1.newLine();
      _builder_1.append("      ");
      _builder_1.append("return $inSupport(rand);");
      _builder_1.newLine();
      _builder_1.append("    ");
      _builder_1.append("}");
      _builder_1.newLine();
      ...
      _builder_1.newLine();
      _builder_1.append("    ");
      _builder_1.append("private boolean $inSupport(final Random rand) {");
      _builder_1.newLine();
      _builder_1.append("      ");
      _builder_1.append("return rand.nextBoolean();");
      _builder_1.newLine();
      _builder_1.append("    ");
      _builder_1.append("}");
      _builder_1.newLine();
