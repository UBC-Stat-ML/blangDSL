...
public class BlangDslGeneratorTest {
  ...
  public void simpleNormalModel() {
    try {
      ...
      _builder_1.newLine();
      _builder_1.append("  ");
      _builder_1.append("private static Supplier<Real> $generated_setupSubModel0Param0(final Real mean) {");
      _builder_1.newLine();
      _builder_1.append("    ");
      _builder_1.append("new Supplier<Real>() {");
      _builder_1.newLine();
      _builder_1.append("        ");
      ...
      _builder_1.newLine();
      _builder_1.append("  ");
      _builder_1.append("private static Supplier<Real> $generated_setupSubModel0Param1(final Real mean) {");
      _builder_1.newLine();
      _builder_1.append("    ");
      _builder_1.append("new Supplier<Real>() {");
      _builder_1.newLine();
