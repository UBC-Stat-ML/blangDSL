...
entryRuleBlangModel returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getBlangModelRule()); }
	iv_ruleBlangModel=ruleBlangModel
	{ $current=$iv_ruleBlangModel.current; }
	EOF;

// Rule BlangModel
ruleBlangModel returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleDistInit returns [String current=null]:
	{ newCompositeNode(grammarAccess.getDistInitRule()); }
	iv_ruleDistInit=ruleDistInit
	{ $current=$iv_ruleDistInit.current.getText(); }
	EOF;

// Rule DistInit
ruleDistInit returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
