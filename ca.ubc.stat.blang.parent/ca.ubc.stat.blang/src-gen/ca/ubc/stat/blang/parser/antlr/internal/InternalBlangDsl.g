...
entryRuleLaws returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getLawsRule()); }
	iv_ruleLaws=ruleLaws
	{ $current=$iv_ruleLaws.current; }
	EOF;

// Rule Laws
ruleLaws returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
@after {
	...
	(
		...
		{
			$current = $this_SupportFactor_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
...
entryRuleSupportFactor returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getSupportFactorRule()); }
	iv_ruleSupportFactor=ruleSupportFactor
	{ $current=$iv_ruleSupportFactor.current; }
	EOF;

// Rule SupportFactor
ruleSupportFactor returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleModelParam returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getModelParamRule()); }
	iv_ruleModelParam=ruleModelParam
	{ $current=$iv_ruleModelParam.current; }
	EOF;

// Rule ModelParam
ruleModelParam returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
@after {
	...
	(
		...
		{
			$current = $this_LazyParam_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_ConstParam_1.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleConstParam returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getConstParamRule()); }
	iv_ruleConstParam=ruleConstParam
	{ $current=$iv_ruleConstParam.current; }
	EOF;

// Rule ConstParam
ruleConstParam returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleLazyParam returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getLazyParamRule()); }
	iv_ruleLazyParam=ruleLazyParam
	{ $current=$iv_ruleLazyParam.current; }
	EOF;

// Rule LazyParam
ruleLazyParam returns [EObject current=null]
@init {
	enterRule();
}
@after {
