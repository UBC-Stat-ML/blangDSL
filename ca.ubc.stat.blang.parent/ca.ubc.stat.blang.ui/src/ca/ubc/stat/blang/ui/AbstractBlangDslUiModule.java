...
import ca.ubc.stat.blang.ide.contentassist.antlr.BlangDslParser;
import ca.ubc.stat.blang.ide.contentassist.antlr.PartialBlangDslContentAssistParser;
import ca.ubc.stat.blang.ide.contentassist.antlr.internal.InternalBlangDslLexer;
import ca.ubc.stat.blang.ui.contentassist.BlangDslProposalProvider;
import ca.ubc.stat.blang.ui.editor.BlangDslEditor;
import ca.ubc.stat.blang.ui.labeling.BlangDslDescriptionLabelProvider;
import ca.ubc.stat.blang.ui.labeling.BlangDslLabelProvider;
import ca.ubc.stat.blang.ui.outline.BlangDslOutlineTreeProvider;
import ca.ubc.stat.blang.ui.quickfix.BlangDslQuickfixProvider;
...
/**
 * Manual modifications go to {@link BlangDslUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractBlangDslUiModule extends DefaultXbaseWithAnnotationsUiModule {

	public AbstractBlangDslUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureContentAssistLexer(Binder binder) {
		binder.bind(Lexer.class)
			...
			.to(InternalBlangDslLexer.class);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(ca.ubc.stat.blang.parser.antlr.internal.InternalBlangDslLexer.class);
	}
	...
	public Class<? extends IContentAssistParser> bindIContentAssistParser() {
		return BlangDslParser.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalBlangDslLexer.class).toProvider(LexerProvider.create(InternalBlangDslLexer.class));
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return BlangDslLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(BlangDslDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return BlangDslOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return BlangDslQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return BlangDslProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialBlangDslContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("BlangDsl Compare");
	}
